...
Write-Host -ForegroundColor Red "   ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝";
Write-Host "";
Write-Host -ForegroundColor Blue "   Made By Zulfiqar Chowdhury (Zu1f1y44n ScreenSharer) For ScreenSharing and DFIR - " -NoNewLine
Write-Host -ForegroundColor Red "discord.gg/CVgGvcfbDj";
Write-Host "";
